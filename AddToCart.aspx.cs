    ...
    public partial class AddToCart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    if (Session["Buyitems"] == null)    //To Add Product First Time session will be null
                    {
                        //To Add Product First Time
                        dr = dt.NewRow();
                        ...
                        Session["buyitems"] = dt;
                        GridView1.FooterRow.Cells[5].Text = "Total Amount"; //price column
                        GridView1.FooterRow.Cells[6].Text = grandtotal().ToString(); //quantity column
                        Response.Redirect("AddToCart.aspx");

                    }
                    else
                    {
                        //If Adding Product Is Not First Time i.e. its not empty, Adding 2nd or more time
