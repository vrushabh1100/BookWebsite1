...
<body>
    ...
    <div "width:100%" class="auto-style1">    
        ...
        <br />
        <br />
        <asp:DataList ID="DataList1" runat="server" CellPadding="4" DataKeyField="BookId" DataSourceID="SqlDataSource1" OnItemCommand="DataList1_ItemCommand" RepeatColumns="4" RepeatDirection="Horizontal" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" ForeColor="Black" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
